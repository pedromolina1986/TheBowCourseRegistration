      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-8 md:gap-0">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white">
            <li><a href="#" className="hover:text-gray-300">Diploma Program</a></li>
            <li><a href="#" className="hover:text-gray-300">Post-Diploma</a></li>
            <li><a href="#" className="hover:text-gray-300">Certificate Program</a></li>
          </ul>
        </div>
      </div>
    </div>
