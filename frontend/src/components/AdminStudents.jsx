      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm text-gray-600">Showing 156 results</span>
            ...
            <div key={idx} className="px-6 py-4 hover:bg-gray-50 transition-colors">
              <div className="grid grid-cols-12 gap-4 items-center">
                ...
                <div className="col-span-3">
                  <p className="text-sm text-gray-900 font-medium">{student.program}</p>
                  <p className="text-xs text-gray-500 mt-0.5">{student.duration}</p>
                </div>

                {/* Term */}
                <div className="col-span-2">
                  <span className="text-sm text-gray-900">{student.term}</span>
                </div>
        ...
        <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
          <p className="text-sm text-gray-600">Showing 1-5 of 156 students</p>
          <div className="flex items-center gap-2">
