...
export const config = {
  ...
  port: 1433, // Docker SQL Server port
  options: {
    encrypt: true,               // enable encryption
    trustServerCertificate: true // IMPORTANT: allow self-signed certificate
  }
};

// export const config = {
//   server: process.env.DB_SERVER || 'default_server_name',      // SQL Server name from the .env file
//   port: Number(process.env.DB_PORT || 1433),                  // Adding port for 
